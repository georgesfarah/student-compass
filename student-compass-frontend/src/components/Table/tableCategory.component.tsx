...
import EditCourseCategory from "../dialogs/editCourseCategory.component";
import { toast } from "react-toastify";
import DeleteCategory from "../dialogs/deleteCategoryDialog.component";
...
export default function TableCategoryComponent(props: {
  ...
  return (
    <>
      <Grid item xs={4}>
        <h2 style={{ textAlign: "left", margin: 0 }}>Categories</h2>
      </Grid>
                  ...
                  .map((row) => {
                    return (
                      ...
                      >
                        ...
                        {props.showEdit && <EditCourseCategory id={row.id}></EditCourseCategory>}

                          <DeleteCategory id={row.id}></DeleteCategory>
                        </TableCell>
                      </TableRow>
                    );
                  })}
